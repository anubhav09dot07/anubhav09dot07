...
**`Data Science · Open Source & Linux `**
...
- 🎓 Pursuing **Master of Computer Applications (MCA)** at Ajeenkya DY Patil University, Pune *(Expected May 2027)*
...
**Freelance VFX & Motion Designer** *(2022 – 2024 · Remote)*
- Managed end-to-end production pipelines for visual effects and motion graphics projects
- Delivered high-quality work under strict deadlines using **Blender** and **DaVinci Resolve** on Linux
- Optimized rendering workflows using open-source tools to maximize creative output
...
|--------|-------------|------|
| Master of Computer Applications (MCA) | Ajeenkya DY Patil University (ADYPU), Pune | 2025 – 2027 (Expected) |

**Relevant Coursework:** Data Structures & Algorithms · Python Programming · Data Analytics · Statistics · Linear Algebra · Database Management Systems
